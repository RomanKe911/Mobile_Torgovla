...
public class RecyclerView_Simple_BackUp {
    ...
    public String BackUp_FileData;
    public String BackUp_RNDB_Size;
    public String BackUp_CONSTDB_Size;
    public String BackUp_BASEDB_Size;


    public RecyclerView_Simple_BackUp(String BackUp_AgentName, String BackUp_AgentRegion, String BackUp_FileData,
        ...
        this.BackUp_FileData = BackUp_FileData;
    ...
    public String getBackUp_FileData() {
        return BackUp_FileData;
    }

    public void setBackUp_FileData(String BackUp_FileData) {
        this.BackUp_FileData = BackUp_FileData;
    }
