...
public class WJ_Forma_Zakaza_L2_Sub extends AppCompatActivity
    ...
    public ProgressBar progressBarOR;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context_Activity = WJ_Forma_Zakaza_L2_Sub.this;
       ...
       /* getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        progressBarOR = findViewById(R.id.progressBarLoadingListView);

        Log.e("L2Sub", "Загрузка L2Sub");
        Log.e("LOG//", "_" + perem_switch_group_sql);


        // Ошибки при загрузке 07.11.2023

        Navigation_Menu();           // Normal
...
*/
    ...
    protected void Navigation_Menu() {
        Log.e("TEST", "Navigation_Menu: Start");
        ...
        cursor.close();
        db.close();
        Log.e("TEST", "Navigation_Menu: END");
