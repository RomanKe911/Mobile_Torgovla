...
public class Sunbell_FtpAsyncTask_SQLDB_FILE extends AsyncTask<Sunbell_FtpAction, Void, Boolean> {
    ...
    public Sunbell_FtpAsyncTask_SQLDB_FILE(Context context) {
    ...
    protected Boolean doInBackground(Sunbell_FtpAction... actions) {
        ...
        try {
            ...
            String path_phobe_db = context.getDatabasePath(a.fileName).getAbsolutePath();
