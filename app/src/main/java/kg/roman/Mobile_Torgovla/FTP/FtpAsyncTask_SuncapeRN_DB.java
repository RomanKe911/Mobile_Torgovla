...
public class FtpAsyncTask_SuncapeRN_DB extends AsyncTask<FtpAction, Void, Boolean> {
    ...
    public FtpAsyncTask_SuncapeRN_DB(Context context) {
    ...
    protected Boolean doInBackground(FtpAction... actions) {
        ...
        try {
            ...
            String data = context.getDatabasePath("suncape_rn_db.db3").getAbsolutePath();
