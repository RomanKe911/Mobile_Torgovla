...
public class ITTN_Obmen_Old extends AppCompatActivity {
   ...
   // public HashSet<String> list_clients, list_ntovar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(ITTN_Obmen_Old.this, "Рабочая таблица очищена!", Toast.LENGTH_SHORT).show();
        ...
        btn_download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pDialog = new ProgressDialog(ITTN_Obmen_Old.this);
                ...
                Toast.makeText(ITTN_Obmen_Old.this, "Скачиваим базу данных", Toast.LENGTH_SHORT).show();
                ITTN_Obmen_Old.MyAsyncTask_DownFtp asyncTask = new ITTN_Obmen_Old.MyAsyncTask_DownFtp();
                asyncTask.execute();
        ...
        btn_writeData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Write_New_Data_DB();
                Toast.makeText(ITTN_Obmen_Old.this, "Данные успешно созданы!", Toast.LENGTH_SHORT).show();
                v.setClickable(false);

                Log.e("ЭТТН4", "Клиентов: " + list_clients.size());
                Log.e("ЭТТН4", "Всего_Товар: " + list_ntovar.size());

                ArrayAdapter<String> adapter_clients = new ArrayAdapter<>(ITTN_Obmen_Old.this,
             ...
             /*   for (int i = 0; i < listView_clients.getCount(); i++) {
                ...
                ArrayAdapter<String> adapter_tovar = new ArrayAdapter<>(ITTN_Obmen_Old.this,
        ...
        btn_newFileXml.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pDialog.setMax(100);
                pDialog.show();
                ITTN_Obmen_Old.MyAsyncTask_Sync_New_XML asyncTask = new ITTN_Obmen_Old.MyAsyncTask_Sync_New_XML();
                asyncTask.execute();
                Toast.makeText(ITTN_Obmen_Old.this, "Файл успешно создан", Toast.LENGTH_SHORT).show();
                v.setClickable(false);
            }
        });
        btn_send_file.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pDialog.show();
                // Отправка файла
                ITTN_Obmen_Old.MyAsyncTask_GoToFTP asyncTask = new ITTN_Obmen_Old.MyAsyncTask_GoToFTP();
                Toast.makeText(ITTN_Obmen_Old.this, "Успешно отпрвленны!", Toast.LENGTH_SHORT).show();
                asyncTask.execute();
                v.setClickable(false);
            }
        });
        ...
        btn_up_file_ostatok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pDialog.show();
                // Отправка файла
                ITTN_Obmen_Old.MyAsyncTask_NewFileXMLOstatok asyncTask = new ITTN_Obmen_Old.MyAsyncTask_NewFileXMLOstatok();
                Toast.makeText(ITTN_Obmen_Old.this, "Успешно отпрвленны!", Toast.LENGTH_SHORT).show();
                asyncTask.execute();
            }
        });
    ...
    private class MyAsyncTask_Sync_New_XML extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPostExecute(Void aVoid) { // Вызывается в конце потока
            ...
            pDialog.setProgress(0);
            pDialog.dismiss();
            Toast.makeText(ITTN_Obmen_Old.this, "Отчет успешно создан!", Toast.LENGTH_SHORT).show();
        }
        ...
        private void getFloor() throws InterruptedException {
            ...
            try {
                ...
                String file_put_db = ITTN_Obmen_Old.this.getDatabasePath(name_file_db + ".xml").getAbsolutePath();  // путь к databases
    ...
    private class MyAsyncTask_GoToFTP extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPostExecute(Void aVoid) { // Вызывается в конце потока
            super.onPostExecute(aVoid);
            Toast.makeText(ITTN_Obmen_Old.this, "файл успешно отправлнен", Toast.LENGTH_SHORT).show();
            pDialog.setProgress(0);
            pDialog.cancel();
            pDialog.dismiss();
        }
        ...
        private void getFloor() throws InterruptedException {
            ...
            try {
                ...
                String path_phobe_db = ITTN_Obmen_Old.this.getDatabasePath("MTW_out_ittn_obmen.xml").getAbsolutePath();
    ...
    private class MyAsyncTask_DownFtp extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPostExecute(Void aVoid) { // Вызывается в конце потока
            super.onPostExecute(aVoid);
            Toast.makeText(ITTN_Obmen_Old.this, "файл успешно скачен", Toast.LENGTH_SHORT).show();
            pDialog.setProgress(0);
            pDialog.cancel();
            pDialog.dismiss();
        }
        ...
        private void getFloor() throws InterruptedException {
            ...
            try {
                ...
                String file_phone = ITTN_Obmen_Old.this.getDatabasePath("ittm_base.db3").getAbsolutePath();
                String file_ftp = "/MT_Sunbell_Karakol/MTW_ITTN/ittm_base.db3";

                web.getFileToPhone(file_phone, file_ftp, ITTN_Obmen_Old.this, true);
