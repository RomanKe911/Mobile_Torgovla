...
public class FtpAsyncTask_Logins_Up extends AsyncTask<FtpAction, Void, Boolean> {
    ...
    public FtpAsyncTask_Logins_Up(Context context) {
    ...
    protected Boolean doInBackground(FtpAction... actions) {
        ...
        try {
            ...
            String data = context.getDatabasePath("logins.db3").getAbsolutePath();
...
*/
    ...
    private static void ftpCreateDirectoryTree(FTPClient client, String dirTree ) throws IOException {
        ...
        String[] directories = dirTree.split("/Server/Forma_Zakaz/");
