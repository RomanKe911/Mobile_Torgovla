...
public class Sunbell_FtpAsyncTask_Filial extends AsyncTask<Sunbell_FtpAction, Void, Boolean> {
    ...
    public Sunbell_FtpAsyncTask_Filial(Context context) {
    ...
    protected Boolean doInBackground(Sunbell_FtpAction... actions) {
        ...
        try {
            ...
            String path_phobe_db = context.getDatabasePath("MTW_In_Ostatok_Bishkek.xml").getAbsolutePath();
