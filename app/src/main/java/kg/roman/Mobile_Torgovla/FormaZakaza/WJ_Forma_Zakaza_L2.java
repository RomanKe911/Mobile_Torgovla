...
public class WJ_Forma_Zakaza_L2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context_Activity = WJ_Forma_Zakaza_L2.this;
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                lst_tw_name = ((TextView) view.findViewById(R.id.wj_cont_name)).getText().toString();
                lst_tw_kod = ((TextView) view.findViewById(R.id.wj_cont_kod)).getText().toString();
                lst_tw_kol = ((TextView) view.findViewById(R.id.cont_edit_kol)).getText().toString();
       ...
       /* String query = "SELECT base_RN.Agent, base_RN.Kod_RN, base_RN.Klients, base_RN.UID_Klients, " +
            ...
            if (cursor.getCount() > 0) {
                while (!cursor.isAfterLast()) {
                    ...
                    list_zakaz.add(new ListAdapterSimple_WJ_Zakaz(name, kod_univ, kol, cena, Format_cena_sk, summa, skidka, itogo, image));
                    cursor.moveToNext();
                }
            } else {
                Auto_Summa = 0.0;
    ...
    protected void Sunbell_Switch_Category_NoSwitch(String w_name, String w_group) {
        switch (w_group)
        {
            case "gr_1":topChannelMenu_01.add(w_name.substring(0, 1) + w_name.substring(1).toLowerCase()).setIcon(R.drawable.ic_cost);break;
            default: topChannelMenu_02.add(w_name.substring(0, 1) + w_name.substring(1).toLowerCase()).setIcon(R.drawable.ic_cost);break;
        }
    }
