...
import kg.roman.Mobile_Torgovla.databinding.MtNomenclaturaContentBinding;
...
*/
    ...
    protected void Navigation_Menu(String selectBrends) {
        ...
        try {
            ...
            String sqlBase = mSettings.getString("PEREM_DB3_BASE", "null");

            Log.e(logeTAG, "t1="+ovvr_selectBrends);

            SQLiteDatabase db = getBaseContext().openOrCreateDatabase(sqlBase, MODE_PRIVATE, null);
