...
/*                    image_var = name.substring(0, 2);
                    ...
                    arrayList_clients.add(new ListAdapterSimple_Klients(name, uid, adress, im, "null"));
...
/*    protected void SQL_Debet_List(String l_uid) {
        try {
            SQLiteDatabase db_debet = getApplication().getBaseContext().openOrCreateDatabase("sunbell_base_db.db3", MODE_PRIVATE, null);
