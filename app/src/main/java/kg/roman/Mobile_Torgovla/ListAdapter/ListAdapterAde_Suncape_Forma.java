 ...
 */
public class ListAdapterAde_Suncape_Forma extends BaseAdapter implements Filterable {

    public SharedPreferences sp;
    public String PEREM_K_AG_KodRN, PEREM_SD, PEREM_PHONE;
    Context context;
    ArrayList<ListAdapterSimple_Suncape_Forma> objects;
    CustomFilter filter;
    ArrayList<ListAdapterSimple_Suncape_Forma> filterList;
    TextView textView_ostatok_colors;
    private static final String TAG = "Suncape";


    public ListAdapterAde_Suncape_Forma(Context ctx, ArrayList<ListAdapterSimple_Suncape_Forma> product_str) {
    ...
    public View getView(int pos, View convertView, ViewGroup parent) {
        ...
        if (ostatki_open == true) {
            ...
            textView_ostatok_colors = (TextView) convertView.findViewById(R.id.textView_forma_ostatok);
            TextView kod_univ = (TextView) convertView.findViewById(R.id.textView_forma_kod);
            TextView kod_uid = (TextView) convertView.findViewById(R.id.text_uid_new);
            TextView uid_skald = (TextView) convertView.findViewById(R.id.textView_UID_Sklad);
            TextView name_skald = (TextView) convertView.findViewById(R.id.textView_Name_Sklad);
            //SET DATA TO THEM
           ...
           // cena_kons.setText(objects.get(pos).getCenaKons());
            ...
            kod_uid.setText(objects.get(pos).getKod_uid());
            uid_skald.setText(objects.get(pos).getUid_sklad());
            name_skald.setText(objects.get(pos).getName_sklad());
            ...
            /*File[] filesArray = imagePath_SD2.listFiles();
    ...
    class CustomFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint != null && constraint.length() > 0) {
                ...
                ArrayList<ListAdapterSimple_Suncape_Forma> filters = new ArrayList<ListAdapterSimple_Suncape_Forma>();
                //get specific items
                for (int i = 0; i < filterList.size(); i++) {
                    if (filterList.get(i).getName().toUpperCase().contains(constraint)) {
                        ListAdapterSimple_Suncape_Forma p = new ListAdapterSimple_Suncape_Forma(filterList.get(i).getKod_uid(),
                                ...
                                filterList.get(i).getName_sklad(),
                                filterList.get(i).getUid_sklad());
                        filters.add(p);
                    }
                }
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            // TODO Auto-generated method stub
            objects = (ArrayList<ListAdapterSimple_Suncape_Forma>) results.values;
